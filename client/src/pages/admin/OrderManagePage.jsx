...
function OrderManagePage({ onBack, onSignupClick, onLoginClick, onAdminClick, onLogout, onViewOrders }) {
  ...
  const fetchAllOrders = async () => {
    try {
      ...
      const result = await apiFetchJson('/api/orders?limit=1000', {
        method: 'GET'
      });
  ...
  const handleUpdateStatus = async (orderId, newStatus) => {
    try {
      ...
      const result = await apiFetchJson(`/api/orders/${orderId}/status`, {
        method: 'PUT',
